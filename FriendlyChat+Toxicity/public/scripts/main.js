	...
	model.classify(sentences).then(predictions => {
	        ...
	        for(var i=0; i<7; i++){
	            if(predictions[i].results[0].match){
					isMessageOK = false;
					errorMessage+=predictions[i].label + " was found with probability of " + predictions[i].results[0].probabilities[1];
			...
			if(isMessageOK){
				...
				alert("Toxic message detected, and not allowed! Details:" + errorMessage)
